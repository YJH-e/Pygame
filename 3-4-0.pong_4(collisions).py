...
while not done and lifeLeft > 0: 
    ...
    #I can do all three if statement conditions in one line (see 5-0.space invaders.py), but I find this method bit confusing (single line too long), so I kept the three-line-configuration here.
